/**
 * `@alchemy.run/web-frameworks/sveltekit/aws` — the AWS Lambda deploy
 ...
 * the `@alchemy.run/web-frameworks/aws-lambda` adapter
 ...
 * `@alchemy.run/web-frameworks/aws-lambda` import is inlined by the
...
import { ${wrap} } from '@alchemy.run/web-frameworks/aws-lambda';
...
export const makeAwsAdapter = (options: {
  ...
  return {
    name: "@alchemy.run/web-frameworks/sveltekit/aws",
    result,
