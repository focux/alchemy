# @alchemy.run/web-frameworks/nuxt
...
Workers is the built-in target (`@alchemy.run/web-frameworks/nuxt/cloudflare`); the
...
`@alchemy.run/web-frameworks/nuxt/cloudflare`) implements the contract:
...
import * as Nuxt from "@alchemy.run/web-frameworks/nuxt";

export default Options.make({
  // string form: framework: "@alchemy.run/web-frameworks/nuxt"
...
```ts
// 1. default — omitted: resolves "@alchemy.run/web-frameworks/nuxt/cloudflare"
//    from the project's node_modules
Nuxt.layer({});

// 2. factory — applied to the config the framework assembles from options
import cloudflareTarget from "@alchemy.run/web-frameworks/nuxt/cloudflare";
...
| `target`             | `"@alchemy.run/web-frameworks/nuxt/cloudflare"`                   | Deploy target: value, factory, or module specifier.                                                                                |
