/**
 * `@alchemy.run/web-frameworks/nuxt` — Nuxt integration implementing framework-core's
 * `Framework` service, with the deploy target passed as a value (Cloudflare
 * Workers by default, via the `@alchemy.run/web-frameworks/nuxt/cloudflare` subpath
 * module).
 *
 ...
 * behind `@alchemy.run/web-frameworks/nuxt/cloudflare`.
 */
...
/**
 * The e2e-harness factory contract (`framework: "@alchemy.run/web-frameworks/nuxt"` in
 * `e2e.config.ts`).
 */
const factory = (
