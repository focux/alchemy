...
const secrets = {
  ...
  DISCORD_TOKEN: await alchemy.secret.env.DISCORD_TOKEN,
  DISCORD_APPLICATION_ID: await alchemy.secret.env.DISCORD_APPLICATION_ID,
  DISCORD_PUBLIC_KEY: await alchemy.secret.env.DISCORD_PUBLIC_KEY,
};
