...
// deploy target's configuration (read by @alchemy.run/web-frameworks/waku via
...
export default Options.make({
  target: {
    cloudflare: {
      worker: {
        // `main` and `viteEnvironments` are pinned by @alchemy.run/web-frameworks/waku's
  ...
  // string form (`framework: "@alchemy.run/web-frameworks/waku"`) is equivalent minus
  // the extra option.
